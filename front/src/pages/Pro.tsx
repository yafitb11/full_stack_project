...
const ProductManagement = () => {
    ...
    return (
        <div className="pageDiv overflow-x-auto">
            <div className="pageTextAndButtonsDiv min-w-[360px]">
                <h1>products management</h1>
            </div>

            <div className="bg-white rounded-lg shadow-lg overflow-hidden w-[75%] m-auto xs:w-full min-w-[360px]">
                <table className="w-full">
                    <thead className="bg-gray-100 border-b-2 border-gray-300">
                        <tr>
                            <th className="px-6 py-4 text-center text-sm font-semibold text-gray-700">product</th>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 w-[75%] mt-7 m-auto min-w-[600px]">
